...
public interface RouteAttractionService extends IService<RouteAttraction> {
    ...
    /**
     * 用完整景点列表替换路线日程，支持新增、删除和重新排序。
     * 与 replaceRouteSchedule 的“只更新已有关联记录”语义区分开。
     */
    boolean replaceCompleteSchedule(Integer routeId, List<RouteAttraction> routeAttractions);
