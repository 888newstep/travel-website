-- RabbitMQ message status / Outbox table migration for the currently selected database.
...
-- The same table can work as a transactional Outbox when MQ_OUTBOX_ENABLED=true.
-- Verify the migration before enabling MQ_STATUS_PERSISTENCE_ENABLED or MQ_OUTBOX_ENABLED.
