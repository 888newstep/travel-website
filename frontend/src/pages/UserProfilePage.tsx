...
export function UserProfilePage() {
  ...
  const [stats, setStats] = useState<UserStats>({ totalNotes: 0, totalCollections: 0, totalShares: 0 })
  ...
  const overviewCards = useMemo(
    ...
    () => [
      ...
      { label: '我的路线', value: myRoutes.length, caption: '行程沉淀' },

      { label: '旅行笔记', value: stats.totalNotes || 0, caption: '记录灵感' },

      { label: '收藏数量', value: stats.totalCollections || 0, caption: '常看常新' },

      { label: '分享数量', value: stats.totalShares || 0, caption: '内容传播' },

    ],

    [myRoutes.length, stats],
