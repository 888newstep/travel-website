...
export type RouteTrafficStatus = 'unknown' | 'light' | 'moderate' | 'heavy' | 'severe';
...
export const routeCrudApi = {
    ...
    getRouteTraffic(id: number) {
        return apiClient.get<RouteTrafficResponse>(`/routes/${id}/traffic`);
    },
