...
public class AIAdvancedController {
    ...
    public Result<AIChatResponse> advancedChatbot(@Valid @RequestBody AIAdvancedChatRequest request) {
        log.info("高级聊天请求: conversationId={}", request.getConversationId());
