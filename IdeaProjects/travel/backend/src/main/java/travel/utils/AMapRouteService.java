...
public class AMapRouteService {
    ...
    @Value("${amap.api-key:2fd6a36c6e00f4b58d949f9d7b35c3c5}")
    ...
    public RouteInfo calculateMultiPointRoute(List<double[]> waypoints) {
        ...
        try {
            ...
            String url = String.format(
                    "https://restapi.amap.com/v3/direction/driving?origin=%s&destination=%s&waypoints=%s&key=%s&strategy=0",
                    origin, destination, viaPoints, apiKey
            );
