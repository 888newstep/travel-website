...
public class UploadFile {
     ...
     * @return: java.util.Map<java.lang.String, java.lang.Object>
     */
    public static Map<String, Object> uploadResource(MultipartFile file, String dirPath, String resourcePath) {
        ...
        try {
            ...
            result.put("filePath", resourcePath + fileName);
    ...
    public static String generateUniqueFileName(String originalFilename) {
        return UUID.randomUUID() + "__" + originalFilename;
    }
}
