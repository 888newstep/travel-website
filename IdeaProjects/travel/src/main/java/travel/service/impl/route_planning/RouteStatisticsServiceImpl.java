...
public class RouteStatisticsServiceImpl implements RouteStatisticsService {
    ...
    public RouteStatisticsVO getRouteStatistics(Long routeId) {
        ...
        // 获取收藏次数
        int collectionCount = routeCollectionMapper.selectList(new com.baomidou.mybatisplus.core.conditions.query.QueryWrapper<RouteCollection>().eq("route_id", routeId)).size();
    ...
    public List<TopRouteVO> getTopRoutes(int limit, LocalDateTime startTime, LocalDateTime endTime) {
        ...
        for (Route route : routes) {
            ...
            // 获取收藏次数
            int collectionCount = routeCollectionMapper.selectList(new com.baomidou.mybatisplus.core.conditions.query.QueryWrapper<RouteCollection>().eq("route_id", route.getId())).size();
    ...
    public Map<String, Object> getUserRouteStatistics(Long userId) {
        ...
        // 获取用户收藏的路线数量
        int collectionCount = routeCollectionMapper.selectList(new com.baomidou.mybatisplus.core.conditions.query.QueryWrapper<RouteCollection>().eq("user_id", userId)).size();
